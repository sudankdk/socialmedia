...
from .views import get_user_profile,CustomTokenObtainPairView,CustomRefreshToekn,register,authenticated,toggleFollow,get_user_post
...
urlpatterns = [
    ...
    path('toggle_follow/', toggleFollow),
    path('posts/<str:pk>',get_user_post)
